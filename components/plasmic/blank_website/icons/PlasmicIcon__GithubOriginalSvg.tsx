...
export type GithubOriginalSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function GithubOriginalSvgIcon(props: GithubOriginalSvgIconProps) {
...
export default GithubOriginalSvgIcon;
/* prettier-ignore-end */
